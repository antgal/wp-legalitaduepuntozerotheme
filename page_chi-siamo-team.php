...
<section class="section section-text-light section-center section-contatti section-header mt-0 border-top-0 p-0" style="background:#ffffff url(<?php ldp_get_theme_base_path(); ?>img/team_top.jpg) no-repeat center center;">
...
<div class="container mt-5">
	...
	<h2>Il nostro <strong>Team</strong></h2>
